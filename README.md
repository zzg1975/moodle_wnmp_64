...
***于1998.6与Moodle相遇，在2021.09.01终止Moodle研究工作***

***无需安装，一键运行；学习、研究、开发Moodle的利器***

***本软件包是WNMP + Moodle架构，可用于生产环境***

***运行Moodle最佳的生产环境是LNMP架构***
...
- 12. 彻底解决了H5P互动内容不能正常运行的问题。PHP 8.0.10版本太高，H5P相关代码不能正常运行，降低为PHP 7.4.23后就没问题了。

## 组件版本

- 【Nginx版本】1.20.1 stable
- 【PHP版本】7.4.23 stable【没有使用PHP 8.0.10，因为这个版本的PHP会使H5P互动内容活动无下从H5P hub下载内容类型】
...
**河南省洛阳市孟津育才实验学校刘宏川老师（QQ：390551157）发现手机端Moodle网页里使用Boost主题更适合；**
...
**网友"翌日科技霍晨云，QQ：太阳 3398858230"发现了H5P互动内容插件不能正常从H5P hub安装内容类型。**
