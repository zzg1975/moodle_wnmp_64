...
class __Mustache_e65e4acb7d71425e02dd8c4d80dadf97 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'block4a763b750d0248867f9fd4f75b5116d9'),
            ));
...
';
    ...
    public function block4a763b750d0248867f9fd4f75b5116d9($context)
    {
        $indent = $buffer = '';
