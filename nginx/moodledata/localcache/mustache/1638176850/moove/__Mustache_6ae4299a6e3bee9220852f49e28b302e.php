...
class __Mustache_6ae4299a6e3bee9220852f49e28b302e extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'block1b9c0297d15cc5048ab855dd8ebc385d'),
            ));
...
';
    ...
    public function block1b9c0297d15cc5048ab855dd8ebc385d($context)
    {
        $indent = $buffer = '';
