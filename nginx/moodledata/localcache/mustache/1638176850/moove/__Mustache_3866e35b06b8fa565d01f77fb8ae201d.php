...
class __Mustache_3866e35b06b8fa565d01f77fb8ae201d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockB2cd3b0c0ecda463ac31b54470b67626'),
            ));
...
';
    ...
    public function blockB2cd3b0c0ecda463ac31b54470b67626($context)
    {
        $indent = $buffer = '';
