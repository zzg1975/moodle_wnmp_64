...
class __Mustache_5ae0dda965c89000ea3298a862bf4861 extends Mustache_Template
{
...
';
        // 'isediting' section
        $value = $context->find('isediting');
        $buffer .= $this->section9bdb24d8631ac15e20b99228deee60ad($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section562f0b4990ac432617e980adf730d49c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9bdb24d8631ac15e20b99228deee60ad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section562f0b4990ac432617e980adf730d49c($context, $indent, $value);
